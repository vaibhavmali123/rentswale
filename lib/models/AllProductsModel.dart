class AllProductsModel {
  ...
  AllProductsModel({this.statusCode, this.message, this.allProductList});

  AllProductsModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['status_code'];
    message = json['message'];
    if (json['all_product_list'] != null) {
      allProductList = new List<AllProductList>();
      json['all_product_list'].forEach((v) {
        allProductList.add(new AllProductList.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.allProductList != null) {
      data['all_product_list'] = this.allProductList.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
